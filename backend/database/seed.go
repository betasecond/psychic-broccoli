...
func SeedData() error {
	...
	// 13. 创建消息
	DB.Exec(`
		INSERT INTO messages (user_id, title, content, date, type, status, sender) VALUES
		(1, '课程提醒：React 深入浅出 直播课即将开始', '您报名的 React 深入浅出 直播课将在 30 分钟后开始，请做好准备进入教室。', '2024-03-18 18:30', '提醒', 'unread', '系统通知'),
		(1, '新回复：关于 React Hooks 的讨论', '张老师在您提问的 "React Hooks 最佳实践" 话题下进行了回复，点击查看详细内容。', '2024-03-17 15:20', '互动', 'read', '张老师'),
		(1, '作业成绩公布：CSS 布局实战', '您提交的 "CSS 布局实战" 作业已批改完成，得分为 88 分，请查看详细评价。', '2024-03-16 10:15', '成绩', 'read', '李老师'),
		(1, '新课程上线：Vue 3 实战课程', '平台新上线了 Vue 3 实战课程，包含项目实战和源码分析，感兴趣的同学可以报名学习。', '2024-03-15 09:00', '通知', 'read', '平台公告'),
		(2, '课程提醒：Go语言并发编程 即将开课', '您报名的 Go语言并发编程 课程将于明天开始，请注意查收课程资料。', '2024-03-18 14:30', '提醒', 'unread', '系统通知'),
		(3, '作业提醒：Python装饰器实战 截止日期临近', '您有一个作业 "Python装饰器实战" 即将在2天后截止，请及时提交。', '2024-03-18 10:00', '提醒', 'read', '系统通知')
	`)

	fmt.Println("  ✓ 消息创建完成 (6条消息)")

	// 14. 创建通知
	DB.Exec(`
		INSERT INTO notifications (title, content, date, type) VALUES
		('课程进度提醒', '您已经 3 天没有学习 React 深入浅出 课程了，继续加油！', '2024-03-18 08:00', 'progress'),
		('考试报名提醒', 'TypeScript 概念测试报名即将截止，不要错过考试机会！', '2024-03-17 17:30', 'exam'),
		('新消息提醒', '张老师回复了您在课程讨论区的提问', '2024-03-17 15:20', 'message'),
		('平台公告：系统维护通知', '我们将于3月20日凌晨2点至4点进行系统维护，期间平台可能暂时无法访问，敬请谅解。', '2024-03-18 12:00', 'system'),
		('新功能上线：作业互评功能', '平台新增了作业互评功能，您可以查看其他同学的作业并进行评价。', '2024-03-16 14:00', 'feature')
	`)

	fmt.Println("  ✓ 通知创建完成 (5条通知)")

	// 15. 创建讨论
	DB.Exec(`
		INSERT INTO discussions (title, course, author, replies, last_reply, status) VALUES
		('React Hooks 最佳实践', 'React 深入浅出', '王同学', 12, '2 小时前', 'active'),
		('TypeScript 泛型理解', 'TypeScript 实战', '李同学', 8, '5 小时前', 'active'),
		('CSS Grid 布局详解', '前端开发基础', '张同学', 15, '1 天前', 'hot'),
		('Go 语言并发模式', 'Go语言入门', '赵同学', 5, '3 小时前', 'active'),
		('Python 数据处理技巧', '数据分析基础', '钱同学', 10, '6 小时前', 'hot')
	`)

	fmt.Println("  ✓ 讨论创建完成 (5条讨论)")
